...
class JavaScriptInterface {
    ...
    public void showPlayerState(final int status) {
        ...
        handlerForJavascriptInterface.post(() -> PlayerService.setPlayingStatus(status));
    }

    @JavascriptInterface
    public void showVID(final String vId) {
        Log.d("New Video Id ", vId);
        handlerForJavascriptInterface.post(() -> PlayerService.setImageTitleAuthor(vId));
    }
...
/*
    ...
    public void videosInPlaylist(final String[] items) {
        Log.e("Videos In Playlist", Arrays.toString(items));
    }
*/
